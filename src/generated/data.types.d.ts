...
export interface components {
  schemas: {
    ...
    WorkspaceDetailResponse: {
      ...
      pendingTransferTo?:
        | components['schemas']['AccountContactDetailResponse']
        | null
    }
      ...
      200: {
        ...
        content: {
          'application/json':
            ...
            | components['schemas']['APIKeyDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  iam_views_api_key_create_api_key: {
    ...
    responses: {
      ...
      201: {
        ...
        content: {
          'application/json':
            | components['schemas']['APIKeySummaryPostResponse']
            | components['schemas']['APIKeyDetailPostResponse']
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  sta_views_thing_get_things: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['ThingSummaryResponse'][]
            | components['schemas']['ThingDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  sta_views_datastream_get_datastreams: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['DatastreamSummaryResponse'][]
            | components['schemas']['DatastreamDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  sta_views_observation_get_observations: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['ObservationSummaryResponse'][]
            | components['schemas']['ObservationDetailResponse'][]
            | components['schemas']['ObservationRowResponse']
            | components['schemas']['ObservationColumnarResponse']
        }
      }
      /** @description Forbidden */
      403: {
  ...
  sta_views_observed_property_get_observed_properties: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['ObservedPropertySummaryResponse'][]
            | components['schemas']['ObservedPropertyDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  sta_views_unit_get_units: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['UnitSummaryResponse'][]
            | components['schemas']['UnitDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  sta_views_sensor_get_sensors: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['SensorSummaryResponse'][]
            | components['schemas']['SensorDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  sta_views_processing_level_get_processing_levels: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['ProcessingLevelSummaryResponse'][]
            | components['schemas']['ProcessingLevelDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  sta_views_result_qualifier_get_result_qualifiers: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json':
            | components['schemas']['ResultQualifierSummaryResponse'][]
            | components['schemas']['ResultQualifierDetailResponse'][]
        }
      }
      /** @description Unauthorized */
      401: {
